...
-- NOTE: I assumed the rented films, are those that do not have a return date, meaning they were rented but not returned

SELECT COUNT(*) AS 'Available for Rent', (16044- (COUNT(*))) AS 'Rented'
FROM rental
